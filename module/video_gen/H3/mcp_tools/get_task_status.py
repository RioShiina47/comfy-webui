"""
MCP Tool: VideoGen_H3_get_task_status
Query the processing progress, status, and result of an async MiniMax-H3 video generation task.
"""
...
def VideoGen_H3_get_task_status(task_id: str) -> dict:
    """
    Query the processing progress and final results of an async MiniMax-H3 video generation task.
