...
def create_event_handlers(components: dict, all_components: dict, demo: gr.Blocks):
    ...
    add_ref_btn.click(fn=add_ref_row, inputs=[ref_count], outputs=add_ref_outputs, show_progress=False, api_name=False)
    del_ref_btn.click(fn=delete_ref_row, inputs=[ref_count], outputs=del_ref_outputs, show_progress=False, api_name=False)
    ...
    add_style_ref_btn.click(fn=add_style_ref_row, inputs=[style_ref_count], outputs=add_style_ref_outputs, show_progress=False, api_name=False)
    del_style_ref_btn.click(fn=delete_style_ref_row, inputs=[style_ref_count], outputs=del_style_ref_outputs, show_progress=False, api_name=False)
