...
from .recipe_loader import load_recipe_and_injector_order
...
def process_inputs(task_type: str, ui_values: dict, seed_override=None, prefix: str = None):
    """
    ...
    recipe, injector_order = load_recipe_and_injector_order(recipe_path, dynamic_values, base_path=module_path)
    assembler = WorkflowAssembler(recipe, injector_order=injector_order, base_path=module_path)
