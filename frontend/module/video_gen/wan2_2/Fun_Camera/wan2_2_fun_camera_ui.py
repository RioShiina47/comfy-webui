    ...
    with gr.Column():
        ...
        with gr.Row():
            ...
            with gr.Column(scale=2):
                components['positive_prompt'] = gr.Textbox(label="Prompt", lines=4, placeholder="Describe the scene.")
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                components['output_video'] = gr.Gallery(
                    label="Result", show_label=False, interactive=False, height=496,
                    object_fit="contain", columns=2, preview=True
                )

        with gr.Accordion("Advanced Camera Settings", open=False):
            with gr.Row():
