...
WORKFLOW_RECIPE_PATH = "wan2_2_fun_inpaint_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    local_ui_values['start_image'] = save_temp_image(start_image_pil.copy())
    local_ui_values['end_image'] = save_temp_image(end_image_pil.copy())
