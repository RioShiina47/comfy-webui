...
UI_INFO = {
    "workflow_recipe": "wan2_2_fun_inpaint_recipe.yaml",
    "main_tab": "VideoGen",
    "sub_tab": "Fun Inpaint",
    "run_button_text": "🎨 Generate Inpaint Video"
}
...
def create_ui():
    components = {}
    with gr.Column():
        gr.Markdown("## Wan 2.2 Fun Inpaint (14B) - Lightning")
...
def process_inputs(ui_values, seed_override=None):
    ...
    local_ui_values['start_image'] = save_temp_image(start_image_pil.copy(), "inpaint_start")
    local_ui_values['end_image'] = save_temp_image(end_image_pil.copy(), "inpaint_end")
