...
WORKFLOW_RECIPE_PATH = "ltx2_3_ia2v_recipe.yaml"
WORKFLOW_RECIPE_2X = "ltx2_3_ia2v_2x_recipe.yaml"
WORKFLOW_RECIPE_3X = "ltx2_3_ia2v_3x_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    local_ui_values['filename_prefix'] = f"video/{get_filename_prefix()}_ltx2.3_ia2v"
