...
WORKFLOW_RECIPE_T2V = "ltx2_3_t2v_recipe.yaml"
WORKFLOW_RECIPE_T2V_2X = "ltx2_3_t2v_2x_recipe.yaml"
WORKFLOW_RECIPE_T2V_3X = "ltx2_3_t2v_3x_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    if use_spatial and use_temporal:
        recipe_path = WORKFLOW_RECIPE_T2V_3X
    elif use_spatial:
        recipe_path = WORKFLOW_RECIPE_T2V_2X
    ...
    local_ui_values['loras'] = process_lora_inputs(ui_values, 'ltx2_3_t2v_lora')
