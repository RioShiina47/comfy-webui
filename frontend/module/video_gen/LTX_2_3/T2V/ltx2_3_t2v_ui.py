import gradio as gr
from .ltx2_3_t2v_logic import process_inputs, RESOLUTION_PRESETS
...
def create_ui():
    ...
    with gr.Column():
        gr.Markdown("## LTX-2.3 Text-to-Video")
        gr.Markdown("💡 **Tip:** This model generates video and audio simultaneously from a text prompt.")
        ...
        create_lora_ui(components, "ltx2_3_t2v_lora", required_lora_dirs=REQUIRED_LORA_DIRS)
...
def create_event_handlers(components: dict, all_components: dict, demo: gr.Blocks):
    register_ui_chain_events(components, "ltx2_3_t2v_lora")
