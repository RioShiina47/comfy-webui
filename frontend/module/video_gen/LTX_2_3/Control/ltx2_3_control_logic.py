...
WORKFLOW_RECIPE_1X = "ltx2_3_control_recipe.yaml"
WORKFLOW_RECIPE_2X = "ltx2_3_control_2x_recipe.yaml"
WORKFLOW_RECIPE_3X = "ltx2_3_control_3x_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    if use_spatial and use_temporal:
        ...
        recipe_path = WORKFLOW_RECIPE_1X
    ...
    local_ui_values['control_width'] = width // 2
    local_ui_values['control_height'] = height // 2
    
    local_ui_values['control_lora_name'] = "ltx-2.3-22b-ic-lora-union-control-ref0.5.safetensors"
    ...
    local_ui_values['filename_prefix'] = f"video/{get_filename_prefix()}_ltx2.3_control"

    if local_ui_values.get('use_easy_cache', False):
        local_ui_values['use_easy_cache'] = [{}]

    local_ui_values['loras'] = process_lora_inputs(ui_values, 'ltx2_3_control_lora')
