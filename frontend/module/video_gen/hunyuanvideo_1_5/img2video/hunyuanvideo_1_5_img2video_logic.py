...
def process_inputs(ui_values, seed_override=None):
    ...
    if resolution_key == '480p':
        recipe_path = "hunyuanvideo_1_5_img2video_480p_recipe.yaml"
    elif resolution_key == '720p':
        recipe_path = "hunyuanvideo_1_5_img2video_720p_recipe.yaml"
    else:
        recipe_path = "hunyuanvideo_1_5_img2video_1080p_recipe.yaml"
