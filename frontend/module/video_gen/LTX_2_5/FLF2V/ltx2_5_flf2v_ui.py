import gradio as gr
from .ltx2_5_flf2v_logic import process_inputs, RESOLUTION_PRESETS
from core.utils import create_batched_run_generation
from core.shared_ui import create_lora_ui, register_ui_chain_events

UI_INFO = {
    "main_tab": "VideoGen",
    "sub_tab": "LTX-2.5 FLF2V",
...
def create_ui():
    components = {}
    with gr.Column():
        gr.Markdown("## LTX-2.5 FLFV (First-Last-Frame-Video)")
        ...
        create_lora_ui(components, "ltx2_5_flf2v_lora", required_lora_dirs=REQUIRED_LORA_DIRS)
...
def create_event_handlers(components: dict, all_components: dict, demo: gr.Blocks):
    register_ui_chain_events(components, "ltx2_5_flf2v_lora")
