...
WORKFLOW_RECIPE_PATH = "ltx2_5_ta2v_recipe.yaml"
WORKFLOW_RECIPE_2X = "ltx2_5_ta2v_2x_recipe.yaml"
WORKFLOW_RECIPE_3X = "ltx2_5_ta2v_3x_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    local_ui_values['filename_prefix'] = f"video/{get_filename_prefix()}_ltx2.5_ta2v"
    local_ui_values['loras'] = process_lora_inputs(ui_values, 'ltx2_5_ta2v_lora')
