import gradio as gr
from .ltx2_5_ia2v_logic import process_inputs, RESOLUTION_PRESETS
from core.utils import create_batched_run_generation
from core.shared_ui import create_lora_ui, register_ui_chain_events

UI_INFO = {
    "main_tab": "VideoGen",
    "sub_tab": "LTX-2.5 IA2V",
...
def create_ui():
    components = {}
    with gr.Column():
        gr.Markdown("## LTX-2.5 Image & Audio to Video")
        gr.Markdown("💡 **Tip:** Provide an image and an audio clip. The model will generate a video of the scene and subject in the image animating and synchronizing with the audio.")
        ...
        components['positive_prompt'] = gr.Textbox(label="Prompt", lines=4, placeholder="Describe the scene, motion, and action...")
        ...
        create_lora_ui(components, "ltx2_5_ia2v_lora", required_lora_dirs=REQUIRED_LORA_DIRS)
...
def create_event_handlers(components: dict, all_components: dict, demo: gr.Blocks):
    register_ui_chain_events(components, "ltx2_5_ia2v_lora")
