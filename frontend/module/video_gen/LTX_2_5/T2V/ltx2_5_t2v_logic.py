...
WORKFLOW_RECIPE_T2V = "ltx2_5_t2v_recipe.yaml"
WORKFLOW_RECIPE_T2V_2X = "ltx2_5_t2v_2x_recipe.yaml"
WORKFLOW_RECIPE_T2V_3X = "ltx2_5_t2v_3x_recipe.yaml"
...
def process_inputs(ui_values, seed_override=None):
    ...
    local_ui_values['loras'] = process_lora_inputs(ui_values, 'ltx2_5_t2v_lora')
