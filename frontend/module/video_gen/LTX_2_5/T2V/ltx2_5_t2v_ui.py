import gradio as gr
from .ltx2_5_t2v_logic import process_inputs, RESOLUTION_PRESETS
...
def create_ui():
    ...
    with gr.Column():
        gr.Markdown("## LTX-2.5 Text-to-Video")
        ...
        create_lora_ui(components, "ltx2_5_t2v_lora", required_lora_dirs=REQUIRED_LORA_DIRS)
...
def create_event_handlers(components: dict, all_components: dict, demo: gr.Blocks):
    register_ui_chain_events(components, "ltx2_5_t2v_lora")
