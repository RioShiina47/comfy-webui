...
UI_INFO = { 
    "workflow_recipe": "flux_dev_onereward_inpaint_recipe.yaml",
    "main_tab": "ImageEdit", 
    "sub_tab": "Flux.1-Dev-OneReward Inpaint",
    "run_button_text": "🎨 Inpaint with OneReward" 
}
...
def process_inputs(ui_values, seed_override=None):
    ...
    vals['input_image'] = save_temp_image_from_pil_local(composite_image, "onereward_composite")
