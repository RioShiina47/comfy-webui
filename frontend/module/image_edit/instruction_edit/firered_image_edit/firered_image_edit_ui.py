import gradio as gr
from .firered_image_edit_logic import process_inputs, ASPECT_RATIO_PRESETS
from core.utils import create_batched_run_generation

UI_INFO = {
    "main_tab": "ImageEdit",
    "sub_tab": "FireRed-Image-Edit",
    "run_button_text": "🎨 Edit FireRed Image"
}
...
def create_ui():
    ...
    with gr.Column():
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                components['output_gallery'] = gr.Gallery(label="Result", show_label=False, object_fit="contain", height=375)
