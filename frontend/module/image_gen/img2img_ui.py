...
UI_INFO = { "main_tab": "ImageGen", "sub_tab": "img2img", "run_button_text": "🚀 Generate" }
PREFIX = "img2img"
        ...
        with gr.Row():
            with gr.Column(scale=1):
                components[key('denoise')] = gr.Slider(
                        label="Denoise", minimum=0.0, maximum=1.0, step=0.05, value=0.75
                    )
                with gr.Row():
...
def process_inputs(ui_values, seed_override=None):
    return process_inputs_logic('img2img', ui_values, seed_override)
