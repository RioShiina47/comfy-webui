...
- **🔗 Image generation: matrix-style dynamic workflows**
  ...
  - **Model dimension (`model_type`)**: supports a wide range of model families such as `Boogu-Image`, `PixelDiT`, `ideogram-4`, `Lens`, `FLUX.2`, `Z-Image`, `Qwen-Image`, `ERNIE-Image`, `LongCat-Image`, `Cosmos-Predict2`, `Anima`, `NewBie-Image`, `Ovis-Image`, `HunyuanImage`, `Chroma1-Radiance`, `Chroma1`, `Lumina`, `HiDream-O1`, `HiDream-I1`, `FLUX.1`, `SD3.5`, `SDXL`, `SD1.5`, etc.
